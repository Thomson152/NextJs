...
const Footer = () => {
  return (
    <div className="h-[50px] flex flex-col md:flex-row justify-between items-center pb-10">
      <div className="">
        <h1 className="md:text-[16px] text-[14px]">@2023 Thomson. All rights reversed</h1>
      </div>
